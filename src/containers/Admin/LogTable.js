...
const headCells = [
    ...
    { id: 'targetTitle', numeric: false, disablePadding: false, label: 'Target' },
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell component="th" id={labelId} scope="row" padding="none"
                                                ...
                                                {msToDate(row.date) + ' ' + msToTime(row.date)}
                                            </TableCell>
                                            <TableCell align="left" onClick={()=> onDetailsClicked(row)}>{row.userName}</TableCell>
                                            <TableCell align="left" onClick={()=> onDetailsClicked(row)}>{row.action}</TableCell>
                                            <TableCell align="left" onClick={()=> onDetailsClicked(row)}>{row.targetTitle}</TableCell>
                                        </TableRow>
                                    );
                                })}
                        </TableBody>
